...
void test1() {
  ...
  // cout << "CSS342 title: " << es.getCourseTitle("CSS342") << endl;
  assert(es.getCourseTitle("CSS342") ==
         "Data Structures, Algorithms, and Discrete Mathematics I");
  // check enrollments
  // cout << "es.getEnrolledCourses(1070): " << es.getEnrolledCourses(1070)
  // << endl;
  ...
  // cout << "es.getClassListByLastName( CSS342 ): "
  //<< es.getClassListByLastName("CSS342") << endl;
  ...
  // cout << "es.getClassListByID(CSS342): " << es.getClassListByID("CSS342")
  //<< endl;
